...
BOT_TOKEN = "8962265355:AAH1NancsNq3z54f8kyIrL-sL8p27DzrJtw"
API_KEY = "mino_live_e9fb5bb66571650c3bc747c2a9ae9260"
...
OTP_GROUP_ID = -1004407851706

# ==================== WELCOME MESSAGE CONFIGURATION ====================
WELCOME_MESSAGE = """⚡ INSTAGRAM FAST OTP 𝗕𝗢𝗧 ⚡ 
━━━━━━━━━━━━━━━━━━━━━━
...
REFERRAL_PRICE = 0.020
MIN_WITHDRAW = 50
MAX_WITHDRAW = 10000

# ==================== SUPPORT LINK (EDITABLE) ====================
SUPPORT_LINK = "t.me/Akashtechnical15"      # সাপোর্ট লিংক পরিবর্তনযোগ্য
                ...
                for otp in otps:
                    ...
                    if (matched_key is not None and
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ PANEL", url="https://t.me/InstagramFastOtp_bot", style="primary"),
                                InlineKeyboardButton("📢 CHANNEL", url="t.me/Akashtechnical15", style="primary")
                            ]
                        ])
...
async def fast_allocate_number_multi(query, context, ranges_list, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/+W5F_bVvheBA5YTg1", style="primary")]
    ])
    try:
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "SUPPORT" in text:
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("👨‍💻 DEVELOPER", url="t.me/Akashtechnical15", style="danger")]
        ])
